...
public class MangiareClient {
    ...
    public static void main(String[] args) {
        try {
            ...
            client = new SocketClient("127.0.0.1", 13000);
            clientThread = new Thread(client);
            clientThread.start();
            //Message objMsg = new Message();
            //objMsg.setType("baru");
            //client.send(objMsg);
            //new MangiareClient().startGame();
        } catch (IOException ex) {
            Logger.getLogger(MangiareClient.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
